...
class fitting:
    ...
    def params_set(self,param, corr, t_cycle):
        ...
        # time dependence params are excluded
        param_point['corr_sor_t'] = 0
        param_point['corr_HX_t'] = 0
    ...
    def show_fit_map(self, fitted_params):
        ...
        plt.savefig('Fig/fitting_silica_without_dt.eps')
        plt.show()
...
def main():
    ...
    corr0 = np.array([176, 3174, 151, 1.8e-10,  1, 1])
